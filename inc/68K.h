...
#include <string.h>
    ...
    #include "68KCONF.h"
        ...
        #define         M68K_BIT_0(VALUE)                                   (((VALUE) >> 0) & 1) 
        #define         M68K_BIT_1(VALUE)                                   (((VALUE) >> 1) & 1) 
        #define         M68K_BIT_2(VALUE)                                   (((VALUE) >> 2) & 1) 
        #define         M68K_BIT_3(VALUE)                                   (((VALUE) >> 3) & 1) 
        #define         M68K_BIT_4(VALUE)                                   (((VALUE) >> 4) & 1) 
        #define         M68K_BIT_5(VALUE)                                   (((VALUE) >> 5) & 1) 
        #define         M68K_BIT_6(VALUE)                                   (((VALUE) >> 6) & 1) 
        #define         M68K_BIT_7(VALUE)                                   (((VALUE) >> 7) & 1) 
        #define         M68K_BIT_8(VALUE)                                   (((VALUE) >> 8) & 1) 
        #define         M68K_BIT_9(VALUE)                                   (((VALUE) >> 9) & 1) 
        #define         M68K_BIT_A(VALUE)                                   (((VALUE) >> 10) & 1) 
        #define         M68K_BIT_B(VALUE)                                   (((VALUE) >> 11) & 1) 
        #define         M68K_BIT_C(VALUE)                                   (((VALUE) >> 12) & 1)
        #define         M68K_BIT_D(VALUE)                                   (((VALUE) >> 13) & 1)
        #define         M68K_BIT_E(VALUE)                                   (((VALUE) >> 14) & 1)
        #define         M68K_BIT_F(VALUE)                                   (((VALUE) >> 15) & 1)
        #define         M68K_BIT_10(VALUE)                                  (((VALUE) >> 16) & 1)
        #define         M68K_BIT_11(VALUE)                                  (((VALUE) >> 17) & 1)
        #define         M68K_BIT_12(VALUE)                                  (((VALUE) >> 18) & 1)
        #define         M68K_BIT_13(VALUE)                                  (((VALUE) >> 19) & 1)
        #define         M68K_BIT_14(VALUE)                                  (((VALUE) >> 20) & 1)
        #define         M68K_BIT_15(VALUE)                                  (((VALUE) >> 21) & 1)
        #define         M68K_BIT_16(VALUE)                                  (((VALUE) >> 22) & 1)
        #define         M68K_BIT_17(VALUE)                                  (((VALUE) >> 23) & 1)
        #define         M68K_BIT_18(VALUE)                                  (((VALUE) >> 24) & 1)
        #define         M68K_BIT_19(VALUE)                                  (((VALUE) >> 25) & 1)
        #define         M68K_BIT_1A(VALUE)                                  (((VALUE) >> 26) & 1)
        #define         M68K_BIT_1B(VALUE)                                  (((VALUE) >> 27) & 1)
        #define         M68K_BIT_1C(VALUE)                                  (((VALUE) >> 28) & 1)
        #define         M68K_BIT_1D(VALUE)                                  (((VALUE) >> 29) & 1)
        #define         M68K_BIT_1E(VALUE)                                  (((VALUE) >> 30) & 1)
        #define         M68K_BIT_1F(VALUE)                                  (((VALUE) >> 31) & 1)
        ...
        #define			M68K_REG_SP             CPU.ADDRESS_REGISTER[7]

...
{    
    ...
    // 26/04/25 - THE PC VALUE IS ALREADY DEFINED WITHIN THE HEADER OF A PROGRAM
    // THESE VALUES ARE MORE SO HERE TO BE ABLE TO ACCESS THROUGHOUT EXECUTION
    ...
    printf("%s INITIALISATION COMPLETE.\n", (CPU_TYPE == M68K_CPU_000) ? "68000" :
        (CPU_TYPE == M68K_CPU_010) ? "68010" :
        (CPU_TYPE == M68K_CPU_020) ? "68020" :
        (CPU_TYPE == M68K_CPU_030) ? "68030" : "68040");
}

...
void INITIALIZE_MEMORY(void)
{
    ...
    CPU.MEMORY_MAP[0x00].MEMORY_READ_16 = NULL;
    CPU.MEMORY_MAP[0x00].MEMORY_WRITE_8 = NULL;
    CPU.MEMORY_MAP[0x00].MEMORY_WRITE_16 = NULL;
}

U8 M68K_READ_8(U32 ADDRESS) 
{
    CPU_68K_MEMORY* TEMP = &CPU.MEMORY_MAP[(ADDRESS >> 16) & 0xFF];
    if(TEMP->MEMORY_READ_8) return (*TEMP->MEMORY_READ_8)(M68K_ADDRESS_LINE(ADDRESS));
    return *(U8*)(TEMP->MEMORY_BASE + (ADDRESS & 0xFFFF));
}

U16 M68K_READ_16(U32 ADDRESS) 
{
    CPU_68K_MEMORY* TEMP = &CPU.MEMORY_MAP[(ADDRESS >> 16) & 0xFF];
    if(TEMP->MEMORY_READ_16) return (*TEMP->MEMORY_READ_16)(M68K_ADDRESS_LINE(ADDRESS));
    return *(U16*)(TEMP->MEMORY_BASE + (ADDRESS & 0xFFFF));
}
...
{
    CPU_68K_MEMORY* TEMP = &CPU.MEMORY_MAP[(ADDRESS >> 16) & 0xFF];
    if(TEMP->MEMORY_READ_32) return (*TEMP->MEMORY_READ_32)(M68K_ADDRESS_LINE(ADDRESS));
    return *(U32*)(TEMP->MEMORY_BASE + (ADDRESS & 0xFFFF));
}

void M68K_WRITE_8(U32 ADDRESS, U8 VALUE) 
{
    CPU_68K_MEMORY* TEMP = &CPU.MEMORY_MAP[(ADDRESS >> 16) & 0xFF];
    if(TEMP->MEMORY_WRITE_8) (*TEMP->MEMORY_WRITE_8)(M68K_ADDRESS_LINE(ADDRESS), VALUE);
    else *(U8*)(TEMP->MEMORY_BASE + (ADDRESS & 0xFFFF)) = VALUE;
}

void M68K_WRITE_16(U32 ADDRESS, U16 VALUE) 
{
    CPU_68K_MEMORY* TEMP = &CPU.MEMORY_MAP[(ADDRESS >> 16) & 0xFF];
    if(TEMP->MEMORY_WRITE_16) (*TEMP->MEMORY_WRITE_16)(M68K_ADDRESS_LINE(ADDRESS), VALUE);
    else *(U16*)(TEMP->MEMORY_BASE + (ADDRESS & 0xFFFF)) = VALUE;
}

void M68K_WRITE_32(U32 ADDRESS, U16 VALUE) 
{
    CPU_68K_MEMORY* TEMP = &CPU.MEMORY_MAP[(ADDRESS >> 16) & 0xFF];
    if(TEMP->MEMORY_WRITE_16) (*TEMP->MEMORY_WRITE_16)(M68K_ADDRESS_LINE(ADDRESS + 2), VALUE & 0xFFFF);
    else *(U16*)(TEMP->MEMORY_BASE + ((ADDRESS + 2) & 0xFFFF)) = VALUE;
}
...
{
    unsigned PC_VALUE = M68K_REG_PC;
    M68K_REG_PC += 2;
    return M68K_READ_16(PC_VALUE);
}

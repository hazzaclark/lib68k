...
// 29/03/25
// AS OF RIGHT NOW, THIS FUNCTION IS ONLY HERE TO PROVIDE LIASON BETWEEN THE OPCODES

// AS SOME OPCODES RELY ON THIS READ FUNCTION TO BE ABLE TO HANDLE LONG OPERATIONS

...
int main(void) 
{
    ...
    U32 IMM_HELPER_32 = 0xBAAFFFFF;
    M68K_WRITE_32(0x1000, IMM_HELPER_32);

    U32 IMM_READ_32_FUCK = READ_IMM_32();
    printf("32-BIT-IMM HELPER: WROTE: 0x%08X, READ: 0x%08X\n", IMM_HELPER_32, IMM_READ_32_FUCK);

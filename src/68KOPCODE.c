...
{
    unsigned RESULT = READ_IMM_16();
    unsigned EA = (M68K_EA() + READ_IMM_32());
...
{
    U32 VALUE = M68K_MASK_OUT_ABOVE_32(READ_IMM_16());
    unsigned EA = (M68K_EA() + READ_IMM_32());
    M68K_WRITE_32(VALUE, EA);

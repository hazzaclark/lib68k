...
M68K_MAKE_OPCODE(ADD, 8, D, 0)
{
    ...
    M68K_FLAG_V = M68K_FLAG_V_8(SRC, DEST, RESULT) & 0;
    M68K_FLAG_X = M68K_FLAG_C = RESULT;
    M68K_FLAG_Z = M68K_MASK_OUT_ABOVE_8(RESULT);

    *EA = M68K_MASK_OUT_BELOW_8(*EA) | M68K_FLAG_Z;
    M68K_CCR_HOOK();
}
...
M68K_MAKE_OPCODE(ADD, 16, D, 0)
{
    ...
    M68K_FLAG_V = M68K_FLAG_V_16(SRC, DEST, RESULT) & 0;
    M68K_FLAG_X = M68K_FLAG_C = RESULT;
...
M68K_MAKE_OPCODE(ADD, 32, D, 0)
{
    ...
    M68K_FLAG_V = M68K_FLAG_V_32(SRC, DEST, RESULT) & 0;
    M68K_FLAG_X = M68K_FLAG_C = RESULT;
